...
describe("newUser", ()=> {
    ...
    it('test id 2.1', ()=> {
        ...
        cy.get('.list-group > :nth-child(2)').should('have.value','samir@gmail.com')
    ...
    it('test id 2.2', ()=> {
        ...
        cy.get('.list-group > :nth-child(3)').type('123456')
        cy.get('.list-group > :nth-child(4)').type('123456')
        cy.get('.list-group > :nth-child(2)').should('include.value','.com')
        cy.get('#btnUserEdit').click()
    ...
    it('test id 2.3', ()=> {
        ...
        cy.get('.list-group > :nth-child(2)').type('samirgmail.com')
        cy.get('.list-group > :nth-child(3)').type('123456')
        cy.get('.list-group > :nth-child(4)').type('123456')
        cy.get('.list-group > :nth-child(2)').should('include.value','@')
        cy.get('#btnUserEdit').click()
    ...
    it('test id 1.4', ()=> {
        ...
        cy.get('.list-group > :nth-child(3)').type('123456')
        cy.get('.list-group > :nth-child(4)').type('123456')
        cy.get('.list-group > :nth-child(2)').should('not.have.value','')
        cy.get('#btnUserEdit').click()
