...
describe("newUser", ()=> {
    ...
    it('test id 3.1', ()=> {
        ...
        cy.get('.list-group > :nth-child(3)').should('have.value','samir@gmail.com')
    ...
    it('test id 3.2', ()=> {
        ...
        cy.get('.list-group > :nth-child(3)').type('123456')
        cy.get('.list-group > :nth-child(4)').type('123456')
        cy.get('.list-group > :nth-child(3)').should('have.length.at.least','8')
        cy.get('#btnUserEdit').click()
    ...
    it('test id 3.3', ()=> {
        ...
        cy.get('.list-group > :nth-child(1)').type('samir')
        cy.get('.list-group > :nth-child(2)').type('samir@gmail.com')
        cy.get('.list-group > :nth-child(3)').type('')
        cy.get('.list-group > :nth-child(4)').type('123456')
        cy.get('.list-group > :nth-child(3)').should('not.have.value','')
        cy.get('#btnUserEdit').click()
